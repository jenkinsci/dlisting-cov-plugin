package io.jenkins.plugins.dlisting;
...
public final class DListingReportAdapter extends CoverageReportAdapter {
    ...
    private static final String COVERAGE_ELEMENT_TYPE_D = "D";

    private static final Pattern patternIsCovered = Pattern.compile("(.*) is \\d+% covered");
    private static final Pattern patternErrorIsCovered = Pattern.compile("Error: (.*) is \\d+% covered");
    private static final Pattern patternHasNoCode = Pattern.compile("(.*) has no code");
    ...
    public Document convert(File source) throws CoverageException {
        ...
        try (BufferedReader br = Files.newBufferedReader(Paths.get(source.getPath()))) {
            ...
            if (moduleFileName == null) {
                throw new CoverageException("No module file name found");
            }
    ...
    public static final class DListingReportAdapterDescriptor extends CoverageReportAdapterDescriptor<CoverageReportAdapter> {
        ...
        public String getCoverageElementType() {
            return COVERAGE_ELEMENT_TYPE_D;
        }
